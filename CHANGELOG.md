...
- Added `stremio_stream_bridge.resolve` for conservative movie, series and episode resolution by spoken title.
- Added normalized public metadata without internal add-on keys or private manifest URLs.
- Added title/year ranking, ambiguity handling and structured resolver statuses for voice clients.
